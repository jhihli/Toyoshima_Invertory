              ...
              <tr key={v.id} style={{ borderBottom: '1px solid var(--hair)' }}>
                ...
                <td style={{ ...tdS, textAlign: 'right' }}>
                  <div style={{ display: 'inline-flex', gap: 4 }}>
                    <button onClick={() => openEdit(v)} style={iconBtn} title="Edit"><EditIcon /></button>
                    <button onClick={() => handleDelete(v)} style={{ ...iconBtn, color: 'var(--err)' }} title="Delete"><TrashIcon /></button>
                  </div>
                </td>
              </tr>
            ))}
